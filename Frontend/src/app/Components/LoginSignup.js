    ...
    return (
        <div className="wrapper">
            <div className="title-text text-black">
                <div className={`title ${isLogin ? 'login' : 'signup'}`}>{isLogin ? 'Login' : 'Signup'}</div>
            </div>
            <div className="form-container">
                <div className="slide-controls">
                    ...
                    />
                    <label htmlFor="login" className={`slide login ${isLogin ? 'active' : ''}`} onClick={handleLoginClick}>Login</label>
                    <label htmlFor="signup" className={`slide signup ${!isLogin ? 'active' : ''}`} onClick={handleSignupClick}>Signup</label>
                    <div className={`slider-tab ${isLogin ? '' : 'signup'}`}></div>
                </div>
                <div className="form-inner" style={{ transform: isLogin ? 'translateX(0%)' : 'translateX(-50%)' }}>
                    <form className="login text-black">
                        <div className="field">
                    ...
                    <form className="signup text-black">
                        <div className="field">
        ...
        * {
        ...
        .slide-controls .slider-tab.signup {
          left: 50%;
        }
        input[type="radio"] {
          display: none;
